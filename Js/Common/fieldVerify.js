...
export function validityField(e, submitButton) {
    ...
    if (field.form.checkValidity()) {
        ...
        submitButton.disabled = true; // Disable submit button if form is not valid
    };
...
var hasError = function (field) {
    ...
    if (validity.patternMismatch) { return { type: 'patternMismatch', message: 'Veuillez respecter le format demandé. S\'il vous plaît' }; }; 
    ...
    return { type: 'unknownError', message: 'Le champ est invalide. S\'il vous plaît' };
};
